...
public class CommandInterpreterImpl implements CommandInterpreter, BundleListener {
     ...
     * 
     * E.g. if the commandline is hello world, the _hello method will get
     ...
     * if more than the configured number of lines have been printed without
     * user prompt. This enables the user of the program to have control over
     * scrolling.
     * <p>
