 ...
 * <li><b>INDICATION_FOCUS_ROW</b> causes the cell that has focus to be drawn in
 * a dark color and its content bright.</li>
...
public class CheckableCellRenderer extends DefaultCellRenderer {
	...
	public static final Image IMAGE_CHECKED = SWTX.loadImageResource(Display
			.getCurrent(), "/icons/checked.gif");

	/** Indicator for an unchecked entry / false boolean decision */
	public static final Image IMAGE_UNCHECKED = SWTX.loadImageResource(Display
			.getCurrent(), "/icons/unchecked.gif");
	...
	public static final Image IMAGE_CHECKED_CLICKED = SWTX.loadImageResource(
			Display.getCurrent(), "/icons/checked_clicked.gif");
	...
	public static final Image IMAGE_UNCHECKED_CLICKED = SWTX.loadImageResource(
			Display.getCurrent(), "/icons/unchecked_clicked.gif");
