 ...
 */
public abstract class KTableSortComparator implements Comparator<Integer> {
	...
	public final int compare(Integer o1, Integer o2) {
		int row1 = o1.intValue();
		int row2 = o2.intValue();
		...
		Object content1 = m_Model.doGetContentAt(loc1.x, loc1.y, false);
		Object content2 = m_Model.doGetContentAt(loc2.x, loc2.y, false);
