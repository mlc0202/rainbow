...
public abstract class KTableDefaultModel implements KTableModel {
	...
	protected HashMap<Integer, Integer> m_ColWidths = new HashMap<Integer, Integer>();
	...
	public int getColumnWidth(int col) {
		Integer width = m_ColWidths.get(col);
		if (width == null) {
	...
	public int getRowHeight(int row) {
		Integer height = m_RowHeights.get(row);
		if (height == null) {
	 ...
	 */
	public Object getContentAt(int col, int row, boolean show) {
		return doGetContentAt(col, row, show);
	}
	 ...
	 *         table cell.
	 */
	public abstract Object doGetContentAt(int col, int row, boolean show);
	...
	@Override
	public boolean needNewRow(int row) {
		return false;
	}

	@Override
	public boolean skipFocusCol(int col, int row) {
		return false;
	}
