...
public class KTableCellEditorCheckbox2 extends KTableCellEditorCheckbox {
	...
	private boolean isValidHAlignment(int align) {
		if (align == SWTX.ALIGN_HORIZONTAL_CENTER || align == SWTX.ALIGN_HORIZONTAL_LEFT
	...
	private boolean isValidVAlignment(int align) {
		if (align == SWTX.ALIGN_VERTICAL_TOP || align == SWTX.ALIGN_VERTICAL_CENTER
	 ...
	 */
	@Override
	public boolean isApplicable(int eventType, KTable table, int col, int row, Point clickLocation, String keyInput,
			int stateMask) {
