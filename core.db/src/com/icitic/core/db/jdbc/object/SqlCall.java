...
package com.icitic.core.db.jdbc.object;

import java.util.List;
import java.util.Map;

import com.icitic.core.db.dao.Dao;
import com.icitic.core.db.jdbc.CallableStatementCreator;
import com.icitic.core.db.jdbc.CallableStatementCreatorFactory;
import com.icitic.core.db.jdbc.SqlParameter;
...
public abstract class SqlCall extends RdbmsOperation {
	 ...
	 */
	public SqlCall(Dao dao, String sql) {
		setDao(dao);
		setSql(sql);
	}
