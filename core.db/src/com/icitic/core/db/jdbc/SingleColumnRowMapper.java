...
public class SingleColumnRowMapper<T> implements RowMapper<T> {
	...
	public T mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		if (nrOfColumns != 1) {
			throw new DataAccessException(
					"Incorrect column size: expected 1 actual " + nrOfColumns);
		}
	 ...
	 * @see com.icitic.core.db.jdbc.springframework.jdbc.support.JdbcUtils#getResultSetValue(java.sql.ResultSet,
	 *      int, Class)
